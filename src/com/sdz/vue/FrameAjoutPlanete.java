...
/*Fenetre dédiée à la création d'une planète dans la base de données
 * Elle est appelée dans Fenetre lorsque l'on choisi d'ajouter une planète
 */
public class FrameAjoutPlanete extends JFrame
	{
		/*Création des différents composants pour créer une planètes
		 ...
		 */
		private JLabel nomPlanete, labelSysteme, labelType, labelTemperature,labelTemperature2, labelDiametre, labelDiametre2;
		private JRadioButton telluriqueRadio, gazeuseRadio;
		private JComboBox<String> systemeCombo;
		private JTextField nomPlt, tempPlt, diamPlt;
		private int id = 0;
		private int type = 0;
		...
		public FrameAjoutPlanete()
			{
				this.setTitle("Ajouter une Planète");
		...
		//Mise en méthode de l'initialisation des différents composants de notre page ajout
